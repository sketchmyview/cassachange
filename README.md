...
| diff — keyspace schema diff | ✔ enterprise | ✗ | ✗ |
| generate — migration script from diff | ✔ enterprise | ✗ | ✗ |
| seed — schema-aware test data seeder | ✔ enterprise | ✗ | ✗ |
| dashboard — CI/CD analytics HTML report | ✔ enterprise | ✗ | ✗ |
| contract — schema contract enforcement | ✔ enterprise | ✗ | ✗ |
| capacity — growth projection engine | ✔ enterprise | ✗ | ✗ |
