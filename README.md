...
4. [cassachange.yml Reference](#4-cassachangeyml-reference)
5. [Script Types](#5-script-types)
6. [Folder Structure](#6-folder-structure)
7. [Deploy Protocol](#7-deploy-protocol)
8. [Commands](#8-commands)
9. [Config Profiles](#9-config-profiles)
10. [Connection Modes](#10-connection-modes)
11. [Environment Variables](#11-environment-variables)
12. [Distributed Locking](#12-distributed-locking)
13. [Release Tagging](#13-release-tagging)
14. [Dry Run](#14-dry-run)
15. [Notifications](#15-notifications)
16. [CQL Linter](#16-cql-linter)
17. [Baseline Introspection](#17-baseline-introspection)
18. [Repair](#18-repair)
19. [Multi-Keyspace Deploy](#19-multi-keyspace-deploy)
20. [GitHub Actions CI/CD](#20-github-actions-cicd)
21. [Keyspace Management](#21-keyspace-management)
22. [History Tables Reference](#22-history-tables-reference)
23. [Comparison with Other Tools](#23-comparison-with-other-tools)
...
`history_keyspace` is required. It stores the `change_history` and `deploy_lock` tables. It must exist before the first deploy — create it via Terraform or cqlsh. cassachange never creates keyspaces.
...
## 23. Comparison with Other Tools
